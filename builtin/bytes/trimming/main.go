...
func main() {
	...
	log.Printf("TrimFunc removed 'odd' runes from %q to producce %q", rhyme, trimFunced)
	...
	log.Printf("TrimRight removed runes in %q from the right side of %q to produce %d", whitespace, padded, rightTrimmed)
